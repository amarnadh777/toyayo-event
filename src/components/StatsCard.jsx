...
const StatCard = ({ number, label }) => {
  return (
    ...
    <div className="w-[168px] h-[129px] rounded-[10px] p-[1px] bg-gradient-to-b from-[#2E5AA8] to-[#8FADE0]  shadow-[0_15px_35px_-5px_rgba(0,0,0,0.4)] relative ">
      ...
      <div className="w-full h-full rounded-[9px] bg-gradient-to-b from-[#2F5DAC] to-[#19315B] shadow-[inset_0_4px_4px_#3466BC] flex flex-col items-center justify-center text-white">
        ...
        {/* Number */}
        <span className="text-4xl font-semibold tracking-wide drop-shadow-sm">
          {number}
        </span>
        
        {/* Label */}
        <span className="text-sm font-semibold mt-1 tracking-wide opacity-90">
          {label}
        </span>
