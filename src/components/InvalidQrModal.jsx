    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
      ...
      <div className="relative w-full max-w-sm bg-white rounded-[2rem] px-6 pb-6 pt-16 text-center shadow-2xl animate-in fade-in zoom-in duration-300">
        ...
        <div className="flex flex-col gap-4">
            ...
            <button 
                onClick={onRetry}
                className="mx-auto flex w-[192px] items-center justify-center rounded-[14px] bg-gradient-to-b from-[#000000] to-[#183059] py-4 text-lg font-bold text-white shadow-lg transition-transform active:scale-95"
            >
                Scan Again
            </button>
